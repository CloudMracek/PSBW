...
/**
 * \brief Initializes serial communication with the given baudrate. At this point only 8 data bits and 1 stop bit is supported
*/
void sio_init(int baudrate);

/**
 * \brief Prints a string of characters to the serial
*/
